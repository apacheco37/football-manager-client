...
export type Sidebar_LogoutMutationVariables = Exact<{ [key: string]: never; }>;


export type Sidebar_LogoutMutation = { __typename?: 'Mutation', logout: boolean | null };
...
export const Sidebar_LogoutDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"Sidebar_Logout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"logout"}}]}}]} as unknown as DocumentNode<Sidebar_LogoutMutation, Sidebar_LogoutMutationVariables>;
