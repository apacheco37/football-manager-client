...
export type Match = {
  ...
  homeTeam: Team;
  id: Scalars['ID'];
  lineupPlayers: Array<PlayerOnLineup>;
};
...
export type MatchList_TeamMatchesQuery = { __typename?: 'Query', team: { __typename?: 'Team', matches: Array<{ __typename?: 'Match', id: string, homeTeam: { __typename?: 'Team', name: string }, awayTeam: { __typename?: 'Team', name: string }, events: Array<{ __typename?: 'MatchEvent', type: MatchEventType, team: MatchTeam }> }> } | null };
